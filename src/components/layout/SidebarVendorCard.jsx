...
export default function SidebarVendorCard({ vendor, onClick, variant = "partner" }) {
  ...
  return (
    <div className={`sidebar-vendor-wrap ${isAdminLink ? "admin" : "partner"}`}>
      <button
        type="button"
        className={`sidebar-vendor-card ${vendor.sidebarPulse && !isAdminLink ? "pulse" : ""} ${isAdminLink ? "admin" : ""}`}
        onClick={onClick}
        title={isAdminLink ? "Manage vendor branding" : "Who built this system"}
      >
