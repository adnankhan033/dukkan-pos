...
export const PRODUCT_IMPORT_COLUMNS = [
  ...
  },
  {
    ...
    required: false,
    example: "default",
    hint: "default (store VAT) · zero_rated · exempt. Leave blank for store default.",
  },
  {
    key: "quantity",
    label: "quantity",
...
export function rowToProduct(rawRow, headerMap) {
  ...
  return {
    ...
    vat: get("vat") || get("tax_category") || IMPORT_VAT_DEFAULTS.vat,
...
export function templateInstructionsRows() {
  return [
    ...
    [
      "VAT (vat column)",
      "default (store VAT from Settings) · zero_rated (0%) · exempt (0%)",
    ],
    [
      "VAT example",
      "Pepsi selling_price 11.50 · vat default → store 15% VAT applied automatically",
    ],
